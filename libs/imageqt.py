...
if TYPE_CHECKING:
    ...
    QBuffer: type
    QByteArray = Union[PyQt6.QtCore.QByteArray, PySide6.QtCore.QByteArray, PyQt5.QtCore.QByteArray]
    QIODevice = Union[PyQt6.QtCore.QIODevice, PySide6.QtCore.QIODevice, PyQt5.QtCore.QIODevice]
    QImage = Union[PyQt6.QtGui.QImage, PySide6.QtGui.QImage, PyQt5.QtGui.QImage]
    QPixmap = Union[PyQt6.QtGui.QPixmap, PySide6.QtGui.QPixmap, PyQt5.QtGui.QPixmap]
...
def _toqclass_helper(im: Image.Image | str | QByteArray) -> dict[str, Any]:
    ...
    if isinstance(im, (bytes, str, os.PathLike)):
        im = Image.open(im)
        exclusive_fp = True
